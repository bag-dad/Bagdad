 ...
 * Define menus.
 *
 * Create hardcoded menus and map them to a theme region through $ba->config['theme'].
 */
$ba->config['menus'] = array(
  'navbar' => array(
 ...
 * Template files can reside in the parent or current theme, the CBagdad::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly BAGDAD_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
